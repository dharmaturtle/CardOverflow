...
namespace ThoughtDesign.IdentityProvider.Migrations.IdentityConfigurationDbMigrations
{
    ...
    [Migration("20200908123715_InitializeIdentityConfigurationDb")]
    partial class InitializeIdentityConfigurationDb
    {
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ApiResource", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasName("api_resource. name. uqix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ApiResourceClaim", b =>
                {
                    ...
                    b.HasIndex("ApiResourceId")
                        .HasName("api_resource_claim. api_resource_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ApiResourceProperty", b =>
                {
                    ...
                    b.HasIndex("ApiResourceId")
                        .HasName("api_resource_property. api_resource_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ApiResourceScope", b =>
                {
                    ...
                    b.HasIndex("ApiResourceId")
                        .HasName("api_resource_scope. api_resource_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ApiResourceSecret", b =>
                {
                    ...
                    b.HasIndex("ApiResourceId")
                        .HasName("api_resource_secret. api_resource_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ApiScopeClaim", b =>
                {
                    ...
                    b.HasIndex("ScopeId")
                        .HasName("api_scope_claim. scope_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ApiScopeProperty", b =>
                {
                    ...
                    b.HasIndex("ScopeId")
                        .HasName("api_scope_property. scope_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientClaim", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasName("client_claim. client_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientCorsOrigin", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasName("client_cors_origin. client_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientGrantType", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasName("client_grant_type. client_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientIdPRestriction", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasName("client_idp_restriction. client_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientPostLogoutRedirectUri", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasName("client_post_logout_redirect_uri. client_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientProperty", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasName("client_property. client_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientRedirectUri", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasName("client_redirect_uri. client_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientScope", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasName("client_scope. client_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasName("client_secret. client_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.IdentityResource", b =>
                {
                    ...
                    b.HasIndex("Name")
                        .IsUnique()
                        .HasName("identity_resource. name. uqix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.IdentityResourceClaim", b =>
                {
                    ...
                    b.HasIndex("IdentityResourceId")
                        .HasName("identity_resource_claim. identity_resource_id. ix");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.IdentityResourceProperty", b =>
                {
                    ...
                    b.HasIndex("IdentityResourceId")
                        .HasName("identity_resource_property. identity_resource_id. ix");
