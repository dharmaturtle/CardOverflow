...
CREATE VIEW public."AcquiredCardIsLatest" AS
 SELECT a."Id",
   ...
   FROM (public."AcquiredCard" a
     LEFT JOIN public."Card" c ON ((c."LatestInstanceId" = a."BranchInstanceId")));
...
CREATE INDEX "IX_BranchInstance_CardId" ON public."BranchInstance" USING btree ("CardId");
...
ALTER TABLE ONLY public."AcquiredCard"
    ADD CONSTRAINT "FK_AcquiredCard_BranchInstance_CardId_BranchInstanceId" FOREIGN KEY ("CardId", "BranchInstanceId") REFERENCES public."BranchInstance"("CardId", "Id");
...
ALTER TABLE ONLY public."BranchInstance"
    ADD CONSTRAINT "FK_BranchInstance_Card_CardId" FOREIGN KEY ("CardId") REFERENCES public."Card"("Id");
...
ALTER TABLE ONLY public."Card"
    ADD CONSTRAINT "FK_Card_BranchInstance_LatestInstanceId" FOREIGN KEY ("LatestInstanceId") REFERENCES public."BranchInstance"("Id") DEFERRABLE INITIALLY DEFERRED;
