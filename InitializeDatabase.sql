...
ALTER TABLE ONLY public.branch
    ADD CONSTRAINT "fk$branch$leaf__latest_id" FOREIGN KEY (latest_id, id) REFERENCES public.leaf(id, branch_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY public.commield
    ADD CONSTRAINT "fk$commield$commeaf__latest_id" FOREIGN KEY (latest_id, id) REFERENCES public.commeaf(id, commield_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY public.gromplate
    ADD CONSTRAINT "fk$gromplate$grompleaf__latest_id" FOREIGN KEY (latest_id, id) REFERENCES public.grompleaf(id, gromplate_id) DEFERRABLE INITIALLY DEFERRED;
