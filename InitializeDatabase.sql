...
CREATE TABLE public."TemplateInstance" (
    ...
    "IsDmca" boolean NOT NULL,
    "QuestionXemplate" character varying(4000) NOT NULL,
    "AnswerXemplate" character varying(4000) NOT NULL,
    "ShortQuestionXemplate" character varying(200) NOT NULL,
    "ShortAnswerXemplate" character varying(200) NOT NULL,
...
INSERT INTO public."TemplateInstance" ("Id", "Name", "TemplateId", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionXemplate", "AnswerXemplate", "ShortQuestionXemplate", "ShortAnswerXemplate", "Fields", "EditSummary", "AnkiId", "Hash", "CWeightTsVectorHelper", "TsVector") VALUES (1, 'Basic', 1, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public."TemplateInstance" ("Id", "Name", "TemplateId", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionXemplate", "AnswerXemplate", "ShortQuestionXemplate", "ShortAnswerXemplate", "Fields", "EditSummary", "AnkiId", "Hash", "CWeightTsVectorHelper", "TsVector") VALUES (2, 'Basic (and reversed card) - Card 1', 2, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public."TemplateInstance" ("Id", "Name", "TemplateId", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionXemplate", "AnswerXemplate", "ShortQuestionXemplate", "ShortAnswerXemplate", "Fields", "EditSummary", "AnkiId", "Hash", "CWeightTsVectorHelper", "TsVector") VALUES (3, 'Basic (optional reversed card) - Card 1', 3, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public."TemplateInstance" ("Id", "Name", "TemplateId", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionXemplate", "AnswerXemplate", "ShortQuestionXemplate", "ShortAnswerXemplate", "Fields", "EditSummary", "AnkiId", "Hash", "CWeightTsVectorHelper", "TsVector") VALUES (4, 'Basic (type in the answer)', 4, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public."TemplateInstance" ("Id", "Name", "TemplateId", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionXemplate", "AnswerXemplate", "ShortQuestionXemplate", "ShortAnswerXemplate", "Fields", "EditSummary", "AnkiId", "Hash", "CWeightTsVectorHelper", "TsVector") VALUES (5, 'Cloze', 5, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public."TemplateInstance" ("Id", "Name", "TemplateId", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionXemplate", "AnswerXemplate", "ShortQuestionXemplate", "ShortAnswerXemplate", "Fields", "EditSummary", "AnkiId", "Hash", "CWeightTsVectorHelper", "TsVector") VALUES (6, 'Basic (type in the answer)', 4, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public."TemplateInstance" ("Id", "Name", "TemplateId", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionXemplate", "AnswerXemplate", "ShortQuestionXemplate", "ShortAnswerXemplate", "Fields", "EditSummary", "AnkiId", "Hash", "CWeightTsVectorHelper", "TsVector") VALUES (7, 'Cloze', 5, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
