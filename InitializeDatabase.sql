...
CREATE TABLE public.commield_instance (
    id integer NOT NULL,
    ...
    ts_vector tsvector,
    CONSTRAINT "commield_instance$b_weight_ts_vector_helper$is_null" CHECK ((b_weight_ts_vector_helper IS NULL))
);


ALTER TABLE public.commield_instance OWNER TO postgres;

ALTER TABLE public.commield_instance ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."commield_instance$id$seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.commield_instance0leaf (
    leaf_id integer NOT NULL,
    commield_instance_id integer NOT NULL
);


ALTER TABLE public.commield_instance0leaf OWNER TO postgres;
...
SELECT pg_catalog.setval('public."commield_instance$id$seq"', 1001, false);
...
ALTER TABLE ONLY public.commield_instance
    ADD CONSTRAINT "p_k$commield_instance" PRIMARY KEY (id);


ALTER TABLE ONLY public.commield_instance0leaf
    ADD CONSTRAINT "p_k$commield_instance$leaf" PRIMARY KEY (commield_instance_id, leaf_id);
...
ALTER TABLE ONLY public.commield_instance
    ADD CONSTRAINT "u_q$commield_instance$commield_instance_id__user_id" UNIQUE (id, commield_id);
...
CREATE INDEX idx_fts_communalfieldinstance_tsvector ON public.commield_instance USING gin (ts_vector);
...
CREATE INDEX "ix$commield_instance$commield_id" ON public.commield_instance USING btree (commield_id);


CREATE INDEX "ix$commield_instance$leaf__leaf_id" ON public.commield_instance0leaf USING btree (leaf_id);
...
CREATE TRIGGER tr_communalfieldinstance_beforeinsert BEFORE INSERT ON public.commield_instance FOR EACH ROW EXECUTE FUNCTION public.fn_tr_communalfieldinstance_beforeinsert();
...
ALTER TABLE ONLY public.commield
    ADD CONSTRAINT "fk$commield$commield_instance__latest_instance_id" FOREIGN KEY (latest_instance_id, id) REFERENCES public.commield_instance(id, commield_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY public.commield_instance
    ADD CONSTRAINT "fk$commield_instance$commield__commield_id" FOREIGN KEY (commield_id) REFERENCES public.commield(id);


ALTER TABLE ONLY public.commield_instance0leaf
    ADD CONSTRAINT "fk$commield_instance$leaf__commield_inst" FOREIGN KEY (commield_instance_id) REFERENCES public.commield_instance(id);


ALTER TABLE ONLY public.commield_instance0leaf
    ADD CONSTRAINT "fk$commield_instance$leaf__leaf_id" FOREIGN KEY (leaf_id) REFERENCES public.leaf(id);
