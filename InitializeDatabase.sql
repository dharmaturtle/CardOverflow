...
CREATE TABLE public.card (
    ...
    ts_vector tsvector,
    CONSTRAINT "card$ts_vector_helper$is_null" CHECK ((ts_vector_helper IS NULL))
);
...
ALTER TABLE public.card ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."card$id$seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.comment_gromplate ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."comment_gromplate$id$seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.commield ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."commield$id$seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.commeaf (
    ...
    ts_vector tsvector,
    CONSTRAINT "commeaf$b_weight_ts_vector_helper$is_null" CHECK ((b_weight_ts_vector_helper IS NULL))
);
...
ALTER TABLE public.commeaf ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."commeaf$id$seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.commeaf0leaf (
    leaf_id integer NOT NULL,
    commeaf_id integer NOT NULL
);


ALTER TABLE public.commeaf0leaf OWNER TO postgres;
...
ALTER TABLE public.gromplate ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."gromplate$id$seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.grompleaf (
    ...
    ts_vector tsvector,
    CONSTRAINT "grompleaf$c_weight_ts_vector_helper$is_null" CHECK ((c_weight_ts_vector_helper IS NULL))
);
...
ALTER TABLE public.grompleaf ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."grompleaf$id$seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.relationship0card (
...
ALTER TABLE public.relationship0card OWNER TO postgres;
...
CREATE VIEW public.leaf_relationship_count AS
 SELECT sac.leaf_id AS source_leaf_id,
    ...
    ( SELECT r.name
         ...
         LIMIT 1) AS name,
    count(*) AS count
   FROM ((public.relationship0card rac
...
ALTER TABLE public.tag0card OWNER TO postgres;
...
CREATE VIEW public.leaf_tag_count AS
 SELECT i.id AS leaf_id,
   ...
   FROM ((public.leaf i
     ...
     JOIN public.tag0card ta ON ((ta.card_id = cc.id)))
...
CREATE TABLE public.tag0user0grompleaf (
    user_id integer NOT NULL,
    grompleaf_id integer NOT NULL,
...
ALTER TABLE public.tag0user0grompleaf OWNER TO postgres;
...
CREATE TABLE public.user0grompleaf (
    user_id integer NOT NULL,
    grompleaf_id integer NOT NULL,
    default_card_setting_id integer NOT NULL
);
...
ALTER TABLE public.user0grompleaf OWNER TO postgres;

CREATE TABLE public.vote0comment_gromplate (
    comment_gromplate_id integer NOT NULL,
    user_id integer NOT NULL
);


ALTER TABLE public.vote0comment_gromplate OWNER TO postgres;
...
INSERT INTO public.gromplate (id, author_id, latest_instance_id, is_listed) VALUES (1, 2, 1001, true);
INSERT INTO public.gromplate (id, author_id, latest_instance_id, is_listed) VALUES (2, 2, 1002, true);
INSERT INTO public.gromplate (id, author_id, latest_instance_id, is_listed) VALUES (3, 2, 1003, true);
INSERT INTO public.gromplate (id, author_id, latest_instance_id, is_listed) VALUES (4, 2, 1006, true);
INSERT INTO public.gromplate (id, author_id, latest_instance_id, is_listed) VALUES (5, 2, 1007, true);
...
INSERT INTO public.user0grompleaf (user_id, grompleaf_id, default_card_setting_id) VALUES (3, 1001, 3);
INSERT INTO public.user0grompleaf (user_id, grompleaf_id, default_card_setting_id) VALUES (3, 1002, 3);
INSERT INTO public.user0grompleaf (user_id, grompleaf_id, default_card_setting_id) VALUES (3, 1003, 3);
INSERT INTO public.user0grompleaf (user_id, grompleaf_id, default_card_setting_id) VALUES (3, 1006, 3);
INSERT INTO public.user0grompleaf (user_id, grompleaf_id, default_card_setting_id) VALUES (3, 1005, 3);
...
SELECT pg_catalog.setval('public."card$id$seq"', 1, false);


SELECT pg_catalog.setval('public."comment_gromplate$id$seq"', 1, false);


SELECT pg_catalog.setval('public."comment_stack$id$seq"', 1, false);


SELECT pg_catalog.setval('public."commield$id$seq"', 1, false);


SELECT pg_catalog.setval('public."commeaf$id$seq"', 1001, false);
...
SELECT pg_catalog.setval('public."gromplate$id$seq"', 6, false);


SELECT pg_catalog.setval('public."grompleaf$id$seq"', 1008, false);
...
ALTER TABLE ONLY public.card
    ADD CONSTRAINT "p_k$card" PRIMARY KEY (id);


ALTER TABLE ONLY public.comment_gromplate
    ADD CONSTRAINT "p_k$comment_gromplate" PRIMARY KEY (id);
...
ALTER TABLE ONLY public.commield
    ADD CONSTRAINT "p_k$commield" PRIMARY KEY (id);


ALTER TABLE ONLY public.commeaf
    ADD CONSTRAINT "p_k$commeaf" PRIMARY KEY (id);


ALTER TABLE ONLY public.commeaf0leaf
    ADD CONSTRAINT "p_k$commeaf$leaf" PRIMARY KEY (commeaf_id, leaf_id);
...
ALTER TABLE ONLY public.deck_follower
    ADD CONSTRAINT "p_k$deck_follower" PRIMARY KEY (deck_id, follower_id);
...
ALTER TABLE ONLY public.gromplate
    ADD CONSTRAINT "p_k$gromplate" PRIMARY KEY (id);


ALTER TABLE ONLY public.grompleaf
    ADD CONSTRAINT "p_k$grompleaf" PRIMARY KEY (id);
...
ALTER TABLE ONLY public.relationship0card
    ADD CONSTRAINT "p_k$relationship0card" PRIMARY KEY (source_stack_id, target_stack_id, relationship_id, user_id);
...
ALTER TABLE ONLY public.tag0user0grompleaf
    ADD CONSTRAINT "p_k$tag$user__grompleaf" PRIMARY KEY (default_tag_id, grompleaf_id, user_id);


ALTER TABLE ONLY public.tag0card
    ADD CONSTRAINT "p_k$tag0card" PRIMARY KEY (stack_id, tag_id, user_id);
...
ALTER TABLE ONLY public.user0grompleaf
    ADD CONSTRAINT "p_k$user$grompleaf" PRIMARY KEY (grompleaf_id, user_id);


ALTER TABLE ONLY public.vote0comment_gromplate
    ADD CONSTRAINT "p_k$vote$comment_gromplate" PRIMARY KEY (comment_gromplate_id, user_id);
...
ALTER TABLE ONLY public.card
    ADD CONSTRAINT "u_q$card$card_id__user_id__stack_id" UNIQUE (id, stack_id, user_id);


ALTER TABLE ONLY public.commeaf
    ADD CONSTRAINT "u_q$commeaf$commeaf_id__user_id" UNIQUE (id, commield_id);
...
ALTER TABLE ONLY public.grompleaf
    ADD CONSTRAINT "u_q$grompleaf$grompleaf_id__gromplate_id" UNIQUE (id, gromplate_id);
...
CREATE INDEX "ix$card$card_setting_id" ON public.card USING btree (card_setting_id);


CREATE INDEX "ix$card$card_state" ON public.card USING btree (card_state);


CREATE INDEX "ix$card$leaf_id" ON public.card USING btree (leaf_id);


CREATE INDEX "ix$card$user_id" ON public.card USING btree (user_id);


CREATE INDEX "ix$card$user_id__branch_id" ON public.card USING btree (user_id, branch_id);


CREATE UNIQUE INDEX "ix$card$user_id__leaf_id__index" ON public.card USING btree (user_id, leaf_id, index);


CREATE INDEX "ix$card$user_id__stack_id" ON public.card USING btree (user_id, stack_id);


CREATE INDEX "ix$comment_gromplate$gromplate_id" ON public.comment_gromplate USING btree (gromplate_id);


CREATE INDEX "ix$comment_gromplate$user_id" ON public.comment_gromplate USING btree (user_id);
...
CREATE INDEX "ix$commield$author_id" ON public.commield USING btree (author_id);


CREATE INDEX "ix$commeaf$commield_id" ON public.commeaf USING btree (commield_id);


CREATE INDEX "ix$commeaf$leaf__leaf_id" ON public.commeaf0leaf USING btree (leaf_id);
...
CREATE INDEX "ix$gromplate$author_id" ON public.gromplate USING btree (author_id);


CREATE INDEX "ix$grompleaf$gromplate_id" ON public.grompleaf USING btree (gromplate_id);


CREATE INDEX "ix$grompleaf$hash" ON public.grompleaf USING btree (hash);


CREATE INDEX "ix$history$card_id" ON public.history USING btree (card_id);


CREATE INDEX "ix$leaf$branch_id" ON public.leaf USING btree (branch_id);


CREATE INDEX "ix$leaf$grompleaf_id" ON public.leaf USING btree (grompleaf_id);
...
CREATE INDEX "ix$relationship0card__relationship_id" ON public.relationship0card USING btree (relationship_id);


CREATE INDEX "ix$relationship0card__source_card_id" ON public.relationship0card USING btree (source_card_id);


CREATE INDEX "ix$relationship0card__target_card_id" ON public.relationship0card USING btree (target_card_id);
...
CREATE INDEX "ix$tag$user__grompleaf__default_tag_id" ON public.tag0user0grompleaf USING btree (default_tag_id);


CREATE INDEX "ix$tag0card__card_id" ON public.tag0card USING btree (card_id);


CREATE UNIQUE INDEX "ix$tag0card__tag_id__stack_id__user_id" ON public.tag0card USING btree (tag_id, stack_id, user_id);


CREATE INDEX "ix$user$grompleaf__default_card_setting_id" ON public.user0grompleaf USING btree (default_card_setting_id);


CREATE INDEX "ix$user$grompleaf__grompleaf_id" ON public.user0grompleaf USING btree (grompleaf_id);


CREATE INDEX "ix$vote$comment_gromplate__user_id" ON public.vote0comment_gromplate USING btree (user_id);
...
ALTER TABLE ONLY public.card
    ADD CONSTRAINT "fk$card$branch__branch_id" FOREIGN KEY (branch_id) REFERENCES public.branch(id);


ALTER TABLE ONLY public.card
    ADD CONSTRAINT "fk$card$branch__branch_id__stack_id" FOREIGN KEY (stack_id, branch_id) REFERENCES public.branch(stack_id, id);


ALTER TABLE ONLY public.card
    ADD CONSTRAINT "fk$card$card_setting__card_setting_id" FOREIGN KEY (card_setting_id) REFERENCES public.card_setting(id);


ALTER TABLE ONLY public.card
    ADD CONSTRAINT "fk$card$deck__deck_id" FOREIGN KEY (deck_id) REFERENCES public.deck(id);


ALTER TABLE ONLY public.card
    ADD CONSTRAINT "fk$card$leaf__leaf_id" FOREIGN KEY (leaf_id) REFERENCES public.leaf(id);


ALTER TABLE ONLY public.card
    ADD CONSTRAINT "fk$card$leaf__leaf_id__branch_i" FOREIGN KEY (branch_id, leaf_id) REFERENCES public.leaf(branch_id, id);


ALTER TABLE ONLY public.card
    ADD CONSTRAINT "fk$card$stack__stack_id" FOREIGN KEY (stack_id) REFERENCES public.stack(id);


ALTER TABLE ONLY public.card
    ADD CONSTRAINT "fk$card$user__user_id" FOREIGN KEY (user_id) REFERENCES public.padawan(id);


ALTER TABLE ONLY public.comment_gromplate
    ADD CONSTRAINT "fk$comment_gromplate$gromplate__gromplate_id" FOREIGN KEY (gromplate_id) REFERENCES public.gromplate(id);


ALTER TABLE ONLY public.comment_gromplate
    ADD CONSTRAINT "fk$comment_gromplate$user__user_id" FOREIGN KEY (user_id) REFERENCES public.padawan(id);
...
ALTER TABLE ONLY public.commield
    ADD CONSTRAINT "fk$commield$commeaf__latest_instance_id" FOREIGN KEY (latest_instance_id, id) REFERENCES public.commeaf(id, commield_id) DEFERRABLE INITIALLY DEFERRED;


ALTER TABLE ONLY public.commield
    ADD CONSTRAINT "fk$commield$user__author_id" FOREIGN KEY (author_id) REFERENCES public.padawan(id);


ALTER TABLE ONLY public.commeaf
    ADD CONSTRAINT "fk$commeaf$commield__commield_id" FOREIGN KEY (commield_id) REFERENCES public.commield(id);


ALTER TABLE ONLY public.commeaf0leaf
    ADD CONSTRAINT "fk$commeaf$leaf__commield_inst" FOREIGN KEY (commeaf_id) REFERENCES public.commeaf(id);


ALTER TABLE ONLY public.commeaf0leaf
    ADD CONSTRAINT "fk$commeaf$leaf__leaf_id" FOREIGN KEY (leaf_id) REFERENCES public.leaf(id);
...
ALTER TABLE ONLY public.deck_follower
    ADD CONSTRAINT "fk$deck_follower$deck_id" FOREIGN KEY (deck_id) REFERENCES public.deck(id) ON DELETE CASCADE;


ALTER TABLE ONLY public.deck_follower
    ADD CONSTRAINT "fk$deck_follower$follower_id" FOREIGN KEY (follower_id) REFERENCES public.padawan(id);
...
ALTER TABLE ONLY public.gromplate
    ADD CONSTRAINT "fk$gromplate$grompleaf__latest_instance_id" FOREIGN KEY (latest_instance_id, id) REFERENCES public.grompleaf(id, gromplate_id) DEFERRABLE INITIALLY DEFERRED;


ALTER TABLE ONLY public.gromplate
    ADD CONSTRAINT "fk$gromplate$user__author_id" FOREIGN KEY (author_id) REFERENCES public.padawan(id);


ALTER TABLE ONLY public.grompleaf
    ADD CONSTRAINT "fk$grompleaf$gromplate__gromplate_id" FOREIGN KEY (gromplate_id) REFERENCES public.gromplate(id);


ALTER TABLE ONLY public.history
    ADD CONSTRAINT "fk$history$card__card_id" FOREIGN KEY (card_id) REFERENCES public.card(id) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.leaf
    ADD CONSTRAINT "fk$leaf$grompleaf__grompleaf_id" FOREIGN KEY (grompleaf_id) REFERENCES public.grompleaf(id);
...
ALTER TABLE ONLY public.notification
    ADD CONSTRAINT "fk$notification$gromplate__gromplate_id" FOREIGN KEY (gromplate_id) REFERENCES public.gromplate(id);


ALTER TABLE ONLY public.notification
    ADD CONSTRAINT "fk$notification$grompleaf__grompleaf_id" FOREIGN KEY (grompleaf_id) REFERENCES public.grompleaf(id);
...
ALTER TABLE ONLY public.relationship0card
    ADD CONSTRAINT "fk$relationship0card__card__source_collecte" FOREIGN KEY (source_card_id) REFERENCES public.card(id) ON DELETE CASCADE;


ALTER TABLE ONLY public.relationship0card
    ADD CONSTRAINT "fk$relationship0card__card__target_collecte" FOREIGN KEY (target_card_id) REFERENCES public.card(id) ON DELETE CASCADE;


ALTER TABLE ONLY public.relationship0card
    ADD CONSTRAINT "fk$relationship0card__relationship__relationship_id" FOREIGN KEY (relationship_id) REFERENCES public.relationship(id);


ALTER TABLE ONLY public.relationship0card
    ADD CONSTRAINT "fk$relationship0card__source_card__user_id_" FOREIGN KEY (source_card_id, user_id, source_stack_id) REFERENCES public.card(id, user_id, stack_id);


ALTER TABLE ONLY public.relationship0card
    ADD CONSTRAINT "fk$relationship0card__target_card__user_id_" FOREIGN KEY (target_card_id, user_id, target_stack_id) REFERENCES public.card(id, user_id, stack_id);
...
ALTER TABLE ONLY public.tag0user0grompleaf
    ADD CONSTRAINT "fk$tag$user__grompleaf__tag__default_tag_id" FOREIGN KEY (default_tag_id) REFERENCES public.tag(id);


ALTER TABLE ONLY public.tag0user0grompleaf
    ADD CONSTRAINT "fk$tag$user__templat_inst__user__templat_inst__user_id__templat" FOREIGN KEY (user_id, grompleaf_id) REFERENCES public.user0grompleaf(user_id, grompleaf_id);


ALTER TABLE ONLY public.tag0card
    ADD CONSTRAINT "fk$tag0card__card__card_id" FOREIGN KEY (card_id) REFERENCES public.card(id) ON DELETE CASCADE;


ALTER TABLE ONLY public.tag0card
    ADD CONSTRAINT "fk$tag0card__card_id__user_id__stack_id" FOREIGN KEY (card_id, user_id, stack_id) REFERENCES public.card(id, user_id, stack_id) ON DELETE CASCADE;


ALTER TABLE ONLY public.tag0card
    ADD CONSTRAINT "fk$tag0card__tag__tag_id" FOREIGN KEY (tag_id) REFERENCES public.tag(id);
...
ALTER TABLE ONLY public.user0grompleaf
    ADD CONSTRAINT "fk$user$grompleaf__card_setting__default_card_setting_id" FOREIGN KEY (default_card_setting_id) REFERENCES public.card_setting(id);


ALTER TABLE ONLY public.user0grompleaf
    ADD CONSTRAINT "fk$user$grompleaf__grompleaf__grompleaf_id" FOREIGN KEY (grompleaf_id) REFERENCES public.grompleaf(id);


ALTER TABLE ONLY public.user0grompleaf
    ADD CONSTRAINT "fk$user$grompleaf__user__user_id" FOREIGN KEY (user_id) REFERENCES public.padawan(id);


ALTER TABLE ONLY public.vote0comment_gromplate
    ADD CONSTRAINT "fk$vote$comment_gromplate__comment_gromplate__comment_gromplate" FOREIGN KEY (comment_gromplate_id) REFERENCES public.comment_gromplate(id);


ALTER TABLE ONLY public.vote0comment_gromplate
    ADD CONSTRAINT "fk$vote$comment_gromplate__user__user_id" FOREIGN KEY (user_id) REFERENCES public.padawan(id);
