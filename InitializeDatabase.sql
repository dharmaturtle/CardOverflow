...
CREATE TABLE public.branch_instance (
    ...
    gromplate_instance_id integer NOT NULL,
    users integer NOT NULL,
...
CREATE TABLE public.gromplate_instance (
    id integer NOT NULL,
    name character varying(100) NOT NULL,
    ...
    ts_vector tsvector,
    CONSTRAINT "gromplate_instance$c_weight_ts_vector_helper$is_null" CHECK ((c_weight_ts_vector_helper IS NULL))
);


ALTER TABLE public.gromplate_instance OWNER TO postgres;

ALTER TABLE public.gromplate_instance ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."gromplate_instance$id$seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.tag0user0gromplate_instance (
    user_id integer NOT NULL,
    gromplate_instance_id integer NOT NULL,
...
ALTER TABLE public.tag0user0gromplate_instance OWNER TO postgres;
...
CREATE TABLE public.user0gromplate_instance (
    user_id integer NOT NULL,
    gromplate_instance_id integer NOT NULL,
    default_card_setting_id integer NOT NULL
);
...
ALTER TABLE public.user0gromplate_instance OWNER TO postgres;
...
INSERT INTO public.gromplate_instance (id, name, gromplate_id, css, created, modified, latex_pre, latex_post, is_dmca, templates, type, fields, edit_summary, anki_id, hash, c_weight_ts_vector_helper, ts_vector) VALUES (1001, 'Basic', 1, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public.gromplate_instance (id, name, gromplate_id, css, created, modified, latex_pre, latex_post, is_dmca, templates, type, fields, edit_summary, anki_id, hash, c_weight_ts_vector_helper, ts_vector) VALUES (1002, 'Basic (optional reversed card)', 2, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public.gromplate_instance (id, name, gromplate_id, css, created, modified, latex_pre, latex_post, is_dmca, templates, type, fields, edit_summary, anki_id, hash, c_weight_ts_vector_helper, ts_vector) VALUES (1003, 'Basic (and reversed card)', 3, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public.gromplate_instance (id, name, gromplate_id, css, created, modified, latex_pre, latex_post, is_dmca, templates, type, fields, edit_summary, anki_id, hash, c_weight_ts_vector_helper, ts_vector) VALUES (1004, 'Basic (type in the answer)', 4, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public.gromplate_instance (id, name, gromplate_id, css, created, modified, latex_pre, latex_post, is_dmca, templates, type, fields, edit_summary, anki_id, hash, c_weight_ts_vector_helper, ts_vector) VALUES (1005, 'Cloze', 5, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public.gromplate_instance (id, name, gromplate_id, css, created, modified, latex_pre, latex_post, is_dmca, templates, type, fields, edit_summary, anki_id, hash, c_weight_ts_vector_helper, ts_vector) VALUES (1006, 'Basic (type in the answer)', 4, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public.gromplate_instance (id, name, gromplate_id, css, created, modified, latex_pre, latex_post, is_dmca, templates, type, fields, edit_summary, anki_id, hash, c_weight_ts_vector_helper, ts_vector) VALUES (1007, 'Cloze', 5, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public.user0gromplate_instance (user_id, gromplate_instance_id, default_card_setting_id) VALUES (3, 1001, 3);
INSERT INTO public.user0gromplate_instance (user_id, gromplate_instance_id, default_card_setting_id) VALUES (3, 1002, 3);
INSERT INTO public.user0gromplate_instance (user_id, gromplate_instance_id, default_card_setting_id) VALUES (3, 1003, 3);
INSERT INTO public.user0gromplate_instance (user_id, gromplate_instance_id, default_card_setting_id) VALUES (3, 1006, 3);
INSERT INTO public.user0gromplate_instance (user_id, gromplate_instance_id, default_card_setting_id) VALUES (3, 1005, 3);
...
SELECT pg_catalog.setval('public."gromplate_instance$id$seq"', 1008, false);
...
ALTER TABLE ONLY public.gromplate_instance
    ADD CONSTRAINT "p_k$gromplate_instance" PRIMARY KEY (id);
...
ALTER TABLE ONLY public.tag0user0gromplate_instance
    ADD CONSTRAINT "p_k$tag$user__gromplate_instance" PRIMARY KEY (default_tag_id, gromplate_instance_id, user_id);
...
ALTER TABLE ONLY public.user0gromplate_instance
    ADD CONSTRAINT "p_k$user$gromplate_instance" PRIMARY KEY (gromplate_instance_id, user_id);
...
ALTER TABLE ONLY public.gromplate_instance
    ADD CONSTRAINT "u_q$gromplate_instance$gromplate_instance_id__gromplate_id" UNIQUE (id, gromplate_id);
...
CREATE INDEX "ix$gromplate_instance$gromplate_id" ON public.gromplate_instance USING btree (gromplate_id);
...
CREATE INDEX "ix$tag$user__gromplate_instance__default_tag_id" ON public.tag0user0gromplate_instance USING btree (default_tag_id);
...
CREATE INDEX "ix$user$gromplate_instance__gromplate_instance_id" ON public.user0gromplate_instance USING btree (gromplate_instance_id);


CREATE INDEX "ix$user$gromplate_instance__default_card_setting_id" ON public.user0gromplate_instance USING btree (default_card_setting_id);
...
ALTER TABLE ONLY public."gromplate"
    ADD CONSTRAINT "fk$gromplate$gromplate_instance__latest_instance_id" FOREIGN KEY (latest_instance_id, id) REFERENCES public.gromplate_instance(id, gromplate_id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY public.gromplate_instance
    ADD CONSTRAINT "fk$gromplate_instance$gromplate__gromplate_id" FOREIGN KEY (gromplate_id) REFERENCES public."gromplate"(id);
...
ALTER TABLE ONLY public.notification
    ADD CONSTRAINT "fk$notification$gromplate_instance__gromplate_instance_id" FOREIGN KEY (gromplate_instance_id) REFERENCES public.gromplate_instance(id);
...
ALTER TABLE ONLY public.tag0user0gromplate_instance
    ADD CONSTRAINT "fk$tag$user__gromplate_instance__tag__default_tag_id" FOREIGN KEY (default_tag_id) REFERENCES public.tag(id);


ALTER TABLE ONLY public.tag0user0gromplate_instance
    ADD CONSTRAINT "fk$tag$user__templat_inst__user__templat_inst__user_id__templat" FOREIGN KEY (user_id, gromplate_instance_id) REFERENCES public.user0gromplate_instance(user_id, gromplate_instance_id);
...
ALTER TABLE ONLY public.user0gromplate_instance
    ADD CONSTRAINT "fk$user$gromplate_instance__card_setting__default_card_setting_id" FOREIGN KEY (default_card_setting_id) REFERENCES public.card_setting(id);


ALTER TABLE ONLY public.user0gromplate_instance
    ADD CONSTRAINT "fk$user$gromplate_instance__gromplate_instance__gromplate_instance_id" FOREIGN KEY (gromplate_instance_id) REFERENCES public.gromplate_instance(id);


ALTER TABLE ONLY public.user0gromplate_instance
    ADD CONSTRAINT "fk$user$gromplate_instance__user__user_id" FOREIGN KEY (user_id) REFERENCES public.padawan(id);
...
ALTER TABLE ONLY public.vote0comment_gromplate
    ADD CONSTRAINT "fk$vote$comment_gromplate__comment_gromplate__comment_gromplate_id" FOREIGN KEY (comment_gromplate_id) REFERENCES public.comment_gromplate(id);
