...
ALTER TABLE ONLY public.file_2_leaf
    ADD CONSTRAINT "p_k$file_2_leaf" PRIMARY KEY (leaf_id, file_id);
...
ALTER TABLE ONLY public.relationship_2_card
    ADD CONSTRAINT "p_k$relationship_2_card" PRIMARY KEY (source_stack_id, target_stack_id, relationship_id, user_id);
...
ALTER TABLE ONLY public.tag_2_card
    ADD CONSTRAINT "p_k$tag_2_card" PRIMARY KEY (stack_id, tag_id, user_id);
...
CREATE INDEX "ix$commeaf$leaf__leaf_id" ON public.commeaf_2_leaf USING btree (leaf_id);
...
CREATE INDEX "ix$file_2_leaf$file_id" ON public.file_2_leaf USING btree (file_id);
...
CREATE INDEX "ix$relationship_2_card__relationship_id" ON public.relationship_2_card USING btree (relationship_id);


CREATE INDEX "ix$relationship_2_card__source_card_id" ON public.relationship_2_card USING btree (source_card_id);


CREATE INDEX "ix$relationship_2_card__target_card_id" ON public.relationship_2_card USING btree (target_card_id);
...
CREATE INDEX "ix$tag$user__grompleaf__default_tag_id" ON public.tag_2_user_2_grompleaf USING btree (default_tag_id);


CREATE INDEX "ix$tag_2_card__card_id" ON public.tag_2_card USING btree (card_id);


CREATE UNIQUE INDEX "ix$tag_2_card__tag_id__stack_id__user_id" ON public.tag_2_card USING btree (tag_id, stack_id, user_id);


CREATE INDEX "ix$user$grompleaf__default_card_setting_id" ON public.user_2_grompleaf USING btree (default_card_setting_id);


CREATE INDEX "ix$user$grompleaf__grompleaf_id" ON public.user_2_grompleaf USING btree (grompleaf_id);


CREATE INDEX "ix$vote$comment_gromplate__user_id" ON public.vote_2_comment_gromplate USING btree (user_id);


CREATE INDEX "ix$vote$comment_stack__user_id" ON public.vote_2_comment_stack USING btree (user_id);


CREATE INDEX "ix$vote$feedback__user_id" ON public.vote_2_feedback USING btree (user_id);
...
ALTER TABLE ONLY public.file_2_leaf
    ADD CONSTRAINT "fk$file_2_leaf__file__file_id" FOREIGN KEY (file_id) REFERENCES public.file(id);


ALTER TABLE ONLY public.file_2_leaf
    ADD CONSTRAINT "fk$file_2_leaf__leaf__leaf_id" FOREIGN KEY (leaf_id) REFERENCES public.leaf(id);
...
ALTER TABLE ONLY public.relationship_2_card
    ADD CONSTRAINT "fk$relationship_2_card__relationship__relationship_id" FOREIGN KEY (relationship_id) REFERENCES public.relationship(id);


ALTER TABLE ONLY public.relationship_2_card
    ADD CONSTRAINT "fk$relationship_2_card__source_card__user_id_" FOREIGN KEY (source_card_id, user_id, source_stack_id) REFERENCES public.card(id, user_id, stack_id);


ALTER TABLE ONLY public.relationship_2_card
    ADD CONSTRAINT "fk$relationship_2_card__target_card__user_id_" FOREIGN KEY (target_card_id, user_id, target_stack_id) REFERENCES public.card(id, user_id, stack_id);
...
ALTER TABLE ONLY public.tag_2_user_2_grompleaf
    ADD CONSTRAINT "fk$tag$user__templat_inst__user__templat_inst__user_id__templat" FOREIGN KEY (user_id, grompleaf_id) REFERENCES public.user_2_grompleaf(user_id, grompleaf_id);


ALTER TABLE ONLY public.tag_2_card
    ADD CONSTRAINT "fk$tag_2_card__card__card_id" FOREIGN KEY (card_id) REFERENCES public.card(id) ON DELETE CASCADE;


ALTER TABLE ONLY public.tag_2_card
    ADD CONSTRAINT "fk$tag_2_card__card_id__user_id__stack_id" FOREIGN KEY (card_id, user_id, stack_id) REFERENCES public.card(id, user_id, stack_id) ON DELETE CASCADE;


ALTER TABLE ONLY public.tag_2_card
    ADD CONSTRAINT "fk$tag_2_card__tag__tag_id" FOREIGN KEY (tag_id) REFERENCES public.tag(id);
