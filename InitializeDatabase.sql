...
INSERT INTO public."LatestTemplateInstance" ("AuthorId", "TemplateInstanceId", "TemplateId", "Name", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionTemplate", "AnswerTemplate", "ShortQuestionTemplate", "ShortAnswerTemplate", "Fields", "EditSummary", "AnkiId") VALUES (2, 1, 1, 'Basic', '* TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIA', '2019-04-08 02:14:29.581', '2019-06-16 00:53:30', '\documentclass[12pt]{article}
...
\begin{document}
', '* TRIAL * TRIA', false, '* TRIAL *', '{{FrontSide}}

<hr id=answer>

{{Back}}', '', '', 'FrontArial20False0FalseBackArial20False1False', 'Imported from Anki', 1554689669581);
INSERT INTO public."LatestTemplateInstance" ("AuthorId", "TemplateInstanceId", "TemplateId", "Name", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionTemplate", "AnswerTemplate", "ShortQuestionTemplate", "ShortAnswerTemplate", "Fields", "EditSummary", "AnkiId") VALUES (2, 2, 2, '* TRIAL * TRIAL * TRIAL * TRIAL * ', '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
INSERT INTO public."LatestTemplateInstance" ("AuthorId", "TemplateInstanceId", "TemplateId", "Name", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionTemplate", "AnswerTemplate", "ShortQuestionTemplate", "ShortAnswerTemplate", "Fields", "EditSummary", "AnkiId") VALUES (2, 3, 3, '* TRIAL * TRIAL * TRIAL * TRIAL * TRIAL', '* TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIA', '2019-04-08 02:14:29.572', '2019-06-16 00:51:32', '\documentclass[12pt]{article}
\special{papersize=3in,5in}
\usepackage[utf8]{inputenc}
\usepackage{amssymb,amsmath}
\pagestyle{empty}
\setlength{\parindent}{0in}
\begin{document}
', '\end{document}', false, '* TRIAL *', '{{FrontSide}}

<hr id=answer>

{{Back}}', '', '', '* TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * T', '* TRIAL * TRIAL * ', 1554689669572);
INSERT INTO public."LatestTemplateInstance" ("AuthorId", "TemplateInstanceId", "TemplateId", "Name", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionTemplate", "AnswerTemplate", "ShortQuestionTemplate", "ShortAnswerTemplate", "Fields", "EditSummary", "AnkiId") VALUES (2, 4, 4, 'Basic (type in the answer)', '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
\setlength{\parindent}{0in}
\begin{document}
', '* TRIAL * TRIA', false, '* TRIAL * TRIAL * TRIAL ', '* TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * T', '', '', 'FrontArial20False0FalseBackArial20False1False', 'Imported from Anki', 1554689669571);
INSERT INTO public."LatestTemplateInstance" ("AuthorId", "TemplateInstanceId", "TemplateId", "Name", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionTemplate", "AnswerTemplate", "ShortQuestionTemplate", "ShortAnswerTemplate", "Fields", "EditSummary", "AnkiId") VALUES (2, 5, 5, 'Cloze', '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
\setlength{\parindent}{0in}
\begin{document}
', '* TRIAL * TRIA', false, '{{cloze:Text}}', '{{cloze:Text}}<br>
...
INSERT INTO public."TemplateInstance" ("Id", "Name", "TemplateId", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionTemplate", "AnswerTemplate", "ShortQuestionTemplate", "ShortAnswerTemplate", "Fields", "EditSummary", "AnkiId", "Hash") VALUES (1, 'Basic', 1, '.card {
 font-family: arial;
 font-size: 20px;
 text-align: center;
 color: black;
...
', '2019-04-08 02:14:29.577', '2019-06-16 00:51:28', '* TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL *', '\end{document}', false, '{{Front}}', '* TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * T', '', '', 'FrontArial20False0FalseBackArial20False1False', 'Imported from Anki', 1554689669577, '\x7865ec597180b1001f1e050693824b210dee685ebcef3aec1d80ff3e83e7d9dce6a586f6bcc771aadd48ce7903df9d5fac673d1bfd5abd0fa5a09d44cde48fbb');
...
\setlength{\parindent}{0in}
\begin{document}
', '* TRIAL * TRIA', false, '{{Front}}', '{{FrontSide}}
...
\setlength{\parindent}{0in}
\begin{document}
', '\end{document}', false, '* TRIAL * TRIAL * TRIAL ', '{{FrontSide}}
...
INSERT INTO public."TemplateInstance" ("Id", "Name", "TemplateId", "Css", "Created", "Modified", "LatexPre", "LatexPost", "IsDmca", "QuestionTemplate", "AnswerTemplate", "ShortQuestionTemplate", "ShortAnswerTemplate", "Fields", "EditSummary", "AnkiId", "Hash") VALUES (5, 'Cloze', 5, '* TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * TRIAL * T', '2019-04-08 02:14:29.57', '2019-06-16 00:51:55', '\documentclass[12pt]{article}
\special{papersize=3in,5in}
\usepackage[utf8]{inputenc}
\usepackage{amssymb,amsmath}
\pagestyle{empty}
...
INSERT INTO public."User" ("Id", "UserName", "NormalizedUserName", "Email", "NormalizedEmail", "EmailConfirmed", "PasswordHash", "SecurityStamp", "ConcurrencyStamp", "PhoneNumber", "PhoneNumberConfirmed", "TwoFactorEnabled", "LockoutEnd", "LockoutEnabled", "AccessFailedCount", "DisplayName", "DefaultCardSettingId", "ShowNextReviewTime", "ShowRemainingCardCount", "MixNewAndReview", "NextDayStartsAtXHoursPastMidnight", "LearnAheadLimitInMinutes", "TimeboxTimeLimitInMinutes", "IsNightMode") VALUES (2, NULL, NULL, 'theCollective@cardoverflow.io', NULL, false, NULL, NULL, '7f15011b-1605-4b2c-ba98-af5659739d60', NULL, false, false, NULL, false, 0, 'The Collective', 2, true, true, 0, 4, 20, 0, false);
INSERT INTO public."User" ("Id", "UserName", "NormalizedUserName", "Email", "NormalizedEmail", "EmailConfirmed", "PasswordHash", "SecurityStamp", "ConcurrencyStamp", "PhoneNumber", "PhoneNumberConfirmed", "TwoFactorEnabled", "LockoutEnd", "LockoutEnabled", "AccessFailedCount", "DisplayName", "DefaultCardSettingId", "ShowNextReviewTime", "ShowRemainingCardCount", "MixNewAndReview", "NextDayStartsAtXHoursPastMidnight", "LearnAheadLimitInMinutes", "TimeboxTimeLimitInMinutes", "IsNightMode") VALUES (3, NULL, NULL, 'roboturtle@cardoverflow.io', NULL, false, NULL, NULL, 'd622b1ce-0c3b-48a3-9851-506e17bd04ec', NULL, false, false, NULL, false, 0, 'RoboTurtle', 3, true, true, 0, 4, 20, 0, false);
