...
let ``ExampleAppender roundtrips`` signedUp { TemplateCreated = templateCreated; ExampleCreated = exampleCreated; Edit = exampleEdited; StackCreated = stackCreated; RevisionChanged = revisionChanged } = asyncResult {
