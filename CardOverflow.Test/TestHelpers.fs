...
module Constants =
    ...
    let ids_1          = UpsertIds.fromTuple(concept_1, branch_1, leaf_1, [card_1])
    let ids_2          = UpsertIds.fromTuple(concept_2, branch_2, leaf_2, [card_2])
    let ids_3          = UpsertIds.fromTuple(concept_3, branch_3, leaf_3, [card_3])
