...
module Constants =
    ...
    let ids_1          = UpsertIds.fromTuple(concept_1, example_1, leaf_1, [card_1])
    let ids_2          = UpsertIds.fromTuple(concept_2, example_2, leaf_2, [card_2])
    let ids_3          = UpsertIds.fromTuple(concept_3, example_3, leaf_3, [card_3])
