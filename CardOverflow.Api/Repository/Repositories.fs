            ...
            let! concept =
                if userId = 0 then
                    ...
                    db.Card
                        ...
                        .Include(fun x -> x.CardInstances :> IEnumerable<_>)
                            .ThenInclude(fun (x: CardInstanceEntity) -> x.RelationshipSources :> IEnumerable<_>)
                            .ThenInclude(fun (x: RelationshipEntity) -> x.Target.CardTemplateInstance)
                        .Include(fun x -> x.CardInstances :> IEnumerable<_>)
                            .ThenInclude(fun (x: CardInstanceEntity) -> x.RelationshipSources :> IEnumerable<_>)
                            .ThenInclude(fun (x: RelationshipEntity) -> x.Target.AcquiredCards)
                        .Include(fun x -> x.CardInstances :> IEnumerable<_>)
                            .ThenInclude(fun (x: CardInstanceEntity) -> x.RelationshipTargets :> IEnumerable<_>)
                            .ThenInclude(fun (x: RelationshipEntity) -> x.Source.CardTemplateInstance)
                        .Include(fun x -> x.CardInstances :> IEnumerable<_>)
                            .ThenInclude(fun (x: CardInstanceEntity) -> x.RelationshipTargets :> IEnumerable<_>)
                            .ThenInclude(fun (x: RelationshipEntity) -> x.Source.AcquiredCards)
                        .FirstAsync(fun x -> x.Id = cardId)
